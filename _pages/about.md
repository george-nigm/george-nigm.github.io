...
My research experience, which I'm currently engaged in at Samsung, concerns industrial research, proceding a signals by ML algorithms, end-to-end development of new features. In academic research, I've worked in the fields of Uncertainty quantification, Anomaly detection, Deep Learning and Active learning in the Skoltech-Sberbank joint laboratory. Before Skoltech, I was engaged in predictive modeling at "Bank Orenburg" JSC, where I predicted the cash requirements for networks of ATMs using time-series forecasting algorithms and created a discrete optimization system that controls cash management.
